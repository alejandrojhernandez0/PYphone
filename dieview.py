#Alejandro Hernandez
#[modified] dieview.py (Final Project)
#December 18, 2013
#COM 110
...
class DieView:
    ...
    def __init__(self, win, center, size):
        ...
        self.rect.draw(win) #This part is modified, rect is changed
                            #to self.rect so it can have the ability
                            #to be undrawn later
    ...
    def undraw(self):
        """*MODIFIED PART* The die can now delete itself when this is called"""
